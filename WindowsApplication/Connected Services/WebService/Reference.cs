...
namespace WindowsApplication.WebService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WebService.ITransactionManager")]
    public interface ITransactionManager {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITransactionManager/Transfers", ReplyAction="http://tempuri.org/ITransactionManager/TransfersResponse")]
        System.Nullable<double> Transfers(int fromAccountId, int toAccountId, double amount, string notes);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITransactionManager/Transfers", ReplyAction="http://tempuri.org/ITransactionManager/TransfersResponse")]
        System.Threading.Tasks.Task<System.Nullable<double>> TransfersAsync(int fromAccountId, int toAccountId, double amount, string notes);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITransactionManagerChannel : WindowsApplication.WebService.ITransactionManager, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TransactionManagerClient : System.ServiceModel.ClientBase<WindowsApplication.WebService.ITransactionManager>, WindowsApplication.WebService.ITransactionManager {
        ...
        public System.Nullable<double> Transfers(int fromAccountId, int toAccountId, double amount, string notes) {
            return base.Channel.Transfers(fromAccountId, toAccountId, amount, notes);
        }
        
        public System.Threading.Tasks.Task<System.Nullable<double>> TransfersAsync(int fromAccountId, int toAccountId, double amount, string notes) {
            return base.Channel.TransfersAsync(fromAccountId, toAccountId, amount, notes);
        }
