...
namespace BankOfBIT_JP.Controllers
{
    public class NextInvestmentAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NextInvestmentAccountId,NextAvailableNumber")] NextInvestmentAccount nextInvestmentAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NextInvestmentAccountId,NextAvailableNumber")] NextInvestmentAccount nextInvestmentAccount)
        {
            if (ModelState.IsValid)
            {
