...
namespace BankOfBIT_JP.Controllers
{
    public class NextMortgageAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NextMortgageAccountId,NextAvailableNumber")] NextMortgageAccount nextMortgageAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NextMortgageAccountId,NextAvailableNumber")] NextMortgageAccount nextMortgageAccount)
        {
            if (ModelState.IsValid)
            {
