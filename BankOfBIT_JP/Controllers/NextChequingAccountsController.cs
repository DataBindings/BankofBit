...
namespace BankOfBIT_JP.Controllers
{
    public class NextChequingAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NextChequingAccountId,NextAvailableNumber")] NextChequingAccount nextChequingAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NextChequingAccountId,NextAvailableNumber")] NextChequingAccount nextChequingAccount)
        {
            if (ModelState.IsValid)
            {
