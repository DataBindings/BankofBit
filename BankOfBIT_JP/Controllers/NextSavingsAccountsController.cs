...
namespace BankOfBIT_JP.Controllers
{
    public class NextSavingsAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NextSavingsAccountId,NextAvailableNumber")] NextSavingsAccount nextSavingsAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NextSavingsAccountId,NextAvailableNumber")] NextSavingsAccount nextSavingsAccount)
        {
            if (ModelState.IsValid)
            {
