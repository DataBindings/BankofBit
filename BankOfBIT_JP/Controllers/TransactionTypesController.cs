...
namespace BankOfBIT_JP.Controllers
{
    public class TransactionTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TransactionTypeId,Description,ServiceCharges")] TransactionType transactionType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TransactionTypeId,Description,ServiceCharges")] TransactionType transactionType)
        {
            if (ModelState.IsValid)
            {
